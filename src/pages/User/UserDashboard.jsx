...
function SpinnerOverlay({ visible = true }) {
  ...
  return (
    <div id="loading-spinner" className={cx("loading-spinner", { show: visible })} aria-hidden={!visible}>
...
function FAQ() {
  const items = [
    ...
    },
    {
      ...
      a:
        "Yes, our platform is fully responsive and works smoothly on any type of device",
    },
    {
            ...
            <div className={cx("main-body")} id="dashboardHome" ref={mainBodyRef}>
              <div className={cx("main-content")}>
                ...
                <p className={cx("text-muted")}>
                  ...
                  <br/>
                  <span className={cx("divider")}><i className="fas fa-lock"></i> Secured Data</span>
